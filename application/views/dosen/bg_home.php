                        ...
                        <div class="widget-box">
										<div class="widget-header header-color-blue">
											<h5 class="bigger lighter">
												Selamat Datang Di Sistem Informasi Akademik Politeknik Muhammadiyah Tegal
											</h5>
									...
									<div class="infobox infobox-green  ">
										...
										<div class="infobox-data">
											<span class="infobox-data-number"><?php $query = $this->db->query("select * from tbl_mahasiswa"); echo $query->num_rows(); ?> Mahasiswa</span>
									...
									<div class="infobox infobox-blue  ">
										...
										<div class="infobox-data">
											<span class="infobox-data-number"><?php $query = $this->db->query("select * from tbl_dosen"); echo $query->num_rows(); ?> Dosen</span>
									...
									<div class="infobox infobox-pink  ">
										...
										<div class="infobox-data">
											<span class="infobox-data-number"><?php $query = $this->db->query("select * from tbl_mk"); echo $query->num_rows(); ?> MK</span>
