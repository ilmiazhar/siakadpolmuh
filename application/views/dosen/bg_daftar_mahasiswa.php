													...
													<tbody>
														<tr>
															...
															foreach($mhs->result_array() as $k)
															{
																	...
																	echo '<td><a class="btn btn-small btn-primary" href="'.base_url().'index.php/dosen/input_nilai/'.$k['nim'].'" title="Masukan Nilai - '.$k['nama_mahasiswa'].'"><i class="icon-on right icon-arrow-right"></i> Masukkan Nilai</a></td>
