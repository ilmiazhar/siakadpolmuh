...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="<?php echo base_url();?>assets/css/tombol.css" />
		<!--[if IE 7]>
										...
										<div class="widget-body">
											<div class="widget-main no-padding">
												<table width="100%">
													...
													<tbody>
														<tr>
														  <td class=""><span class="label label-large label-pink arrowed-right">Hapus database lama terlebih dahulu sebelum melakukan restore database. Lalu buat database baru dengan nama sama dengan database lama</span></td>
													  </tr>
														<tr>
															<td width="913" class=""><div class="row-fluid">
<div class="static">		
        <a href="<?php echo base_url();?>index.php/backup/backupdb"><button class="btn btn-inverse"><i class="icon-cloud-download"></i> Backup Database</button></a>
<br/>
<br/>
<div class="fileUpload btn btn-mini btn-pink">
<?php echo form_open_multipart('backup/restore');?>
	<span>Pilih File</span>
    <input type="file" class="upload" name="datafile" id="datafile" />
	</div>
    <button class="btn btn-purple" type="submit"><span class="glyphicon glyphicon-hdd"></span><i class="icon-cloud-upload"></i> Restore Database</button>
	</form>
</div>
